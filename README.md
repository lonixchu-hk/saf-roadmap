...
2.  Open it in a modern web browser (like Chrome or Edge).
3.  To customize the data, edit the `ACTIVITIES` array within the `<script>` tag in `index.html` or replace it with data from a JSON file.
